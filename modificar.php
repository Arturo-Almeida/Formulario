<?php
	...
	if ($pass != $rpass){
		die('Las contraseñas no coinciden, Verifique <br /> <a href="modificar.html">Volver</a>');
	}

	//ingresamos la informacion a la base de datos
	mysql_query("UPDATE datos set apellidos='$apellidos',email='$email' where nombres='$nombres'", $link ) 
    or die("<h2>Error al Actualizar los datos</h2>");
	echo'
		<script>
